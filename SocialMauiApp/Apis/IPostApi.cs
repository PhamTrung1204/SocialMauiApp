...
public interface IPostApi
{
    ...
    Task<ApiResult<CommentDto>> SaveCommentWithImagesAsync(Guid postId, [AliasAs("photo")] StreamPart? image, [AliasAs("serializedCommentDto")] string serializedCommentDto);

    [Multipart]
    [Put("/api/posts/comments/{commentId}/upload-photo")]
    Task<ApiResult<CommentDto>> UpdateCommentWithImagesAsync(Guid commentId, [AliasAs("photo")] StreamPart? image, [AliasAs("serializedCommentDto")] string serializedCommentDto);
