...
{
    /// <inheritdoc />
    public partial class GetUserPostsBookmarkPostsSProc : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
CREATE OR ALTER PROC GetUserPosts
    @StartIndex INT,
    @PageSize INT,
...
");
            migrationBuilder.Sql(@"
CREATE OR ALTER PROC GetUserBookmarkedPosts
    @StartIndex INT,
    @PageSize INT,
    @CurrentUserId UNIQUEIDENTIFIER
AS
...
");
        ...
        {
            migrationBuilder.Sql(@"DROP PROC IF EXISTS GetUserPosts");
            migrationBuilder.Sql(@"DROP PROC IF EXISTS GetUserBookmarkedPosts");
        }
    }
}
